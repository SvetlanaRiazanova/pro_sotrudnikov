    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(x -> x
                        ...
                        .requestMatchers(HttpMethod.GET, "/sotrudniki").hasRole(ADMIN_ROLE)
                        .requestMatchers(HttpMethod.GET, "/sotrudniki/{id}").hasRole(ADMIN_ROLE)
                        .requestMatchers(HttpMethod.GET, "/sotrudniki/imya/{imya}").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, "/proekti").hasRole(DEVELOPER_ROLE)
                        .requestMatchers(HttpMethod.GET, "/proekti/{id}").hasRole(DEVELOPER_ROLE)
                        ...
                        .requestMatchers(HttpMethod.GET, "/zadaci").hasAnyRole(DEVELOPER_ROLE, USER_ROLE)
                        .requestMatchers(HttpMethod.GET, "/zadaci/{id}").hasAnyRole(DEVELOPER_ROLE, USER_ROLE)
